...
import { Activity, AlertTriangle, Droplets, Gauge, LayoutDashboard, Settings, Waves } from "lucide-react";
...
const nav = [
  ...
  { title: "Pumps", url: "/pumps", icon: Gauge },
  { title: "Reservoirs", url: "/reservoirs", icon: Droplets },
